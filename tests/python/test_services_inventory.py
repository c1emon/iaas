...
@pytest.mark.parametrize(
    ...
    [
        (("services", 0, "owner_vm"), "missing-vm", "owner_vm missing-vm is not declared in the VM inventory"),
...
def test_service_docs_stale_check_is_offline_and_participates_in_root_targets(tmp_path: Path) -> None:
    ...
    assert "generate: pve-generate services-generate foundation-generate" in makefile_text
    assert "check-generated: pve-check services-check foundation-check" in makefile_text
