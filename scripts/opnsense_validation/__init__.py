...
RESOURCE_PATHS = {
    "aliases": ROOT / "ansible/vars/opnsense/aliases.yml",
    "vips": ROOT / "ansible/vars/opnsense/vips.yml",
    "gateways": ROOT / "ansible/vars/opnsense/gateways.yml",
    "filter-rules": ROOT / "ansible/vars/opnsense/filter-rules.yml",
}
TOP_LEVEL = {
