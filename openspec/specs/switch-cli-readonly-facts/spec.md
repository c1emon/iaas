...
Provide a safe read-only Telnet workflow for collecting, parsing, and exporting SKS8300-12X switch version and VLAN facts without mutating switch configuration.
