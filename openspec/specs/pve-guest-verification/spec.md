# pve-guest-verification Specification

## Purpose
Define the explicit, read-only guest-side verification workflow for PVE VMs that
are declared in repository inventory and rendered into generated Ansible
inventory.
