# pve-api-runtime-adapters Specification

## Purpose

Define shared repository-owned PVE API runtime parsing, read-only adapter
contracts, and safe error/redaction behavior for explicit online PVE checks.
