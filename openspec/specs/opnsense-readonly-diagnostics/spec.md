# opnsense-readonly-diagnostics Specification

## Purpose
Provide bounded, explicitly scoped read-only observations of OPNsense alias loading, rule logs and connection states, with protected optional details and honest capability and coverage limits.
