...
- **AND** Astra source and existing operational paths needed by the command SHALL be passed explicitly
...
- **AND** the canonical `iaas_automation.pve_inventory.cli` entrypoint SHALL receive Astra source and output paths explicitly
