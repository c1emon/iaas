...
from iaas.runtime_config import SelectedConfig
...
def run_component(selected: SelectedConfig, operation: str, scope: str, execution: Execution,
    ...
    if component == 'opnsense' and operation in {'read', 'plan', 'apply', 'verify'}:
        from iaas.opnsense_workflow.runtime import run
    ...
    if component == "pve":
        ...
        execution.run(operation, [sys.executable, "-m", f"iaas.pve_inventory.{operation}",
        ...
        inputs = _inputs(selected, execution)
        execution.run("health", [sys.executable, "-m", "iaas.foundation_inventory.cli",
        ...
        from iaas.k3s_automation.operations import validate_deployment_scope, validate_exact_scope
        ...
        if operation == "preflight":
            ...
            from iaas.k3s_automation.operations import validate_upgrade
