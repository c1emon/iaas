...
from iaas.common.validation import as_mapping, require_non_empty_string, require_unknown_keys
from iaas.k3s_automation.config import _secret_ref
from iaas.k3s_automation.operations import validate_deployment_scope
